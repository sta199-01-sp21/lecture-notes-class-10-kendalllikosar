...
51.19% (because 43/84 patients received the placebo)

- What is the probability a randomly selected patient received the placebo
  and had a marked improvement?
8.33% (because 7/84 patients received the placebo and had a marked improvement)
  
- What is the probability a randomly selected patient received the placebo
  and the treatment?
0.00% (no patient of the 84 received both - disjoint possibility)
  
- What is the probability a randomly selected patient had some improvement or
  was on the treatment?
57.14% (because 48/84 had some improvement or received the treatment)
...
Quite close, and even closer as size is increased.
...
I expect that it will be less than 50/50 chance that you will get the same color twice.
...
using mutate command and booleans with draw_1 == draw_2
...
I would assume the probability of roll 1 being the square of roll 2 is lower than the absolute value of the difference between roll 1 and roll 2 being 4. For the first scenario, there are two outcomes of thirty six:(1, 1), (2, 4). For the second scenario, there are four outcomes of thirty six: (1, 5), (5, 1), (2, 4), (4, 2).
